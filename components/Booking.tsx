      ...
      <div className="px-6 md:px-10 max-w-screen-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16">
          ...
          <div className="md:col-span-5">
            ...
            >
              For bookings, festival slots, and collaborations. Response time within 48 hours.
          ...
          <div className="md:col-span-7">
            {status === 'sent' ? (
              ...
              >
                <div style={{ fontSize: '10px', fontWeight: 300, letterSpacing: '0.2em', color: '#D40000', marginBottom: '8px' }}>
                  ■
                </div>
                <div style={{ fontSize: 'clamp(24px, 4vw, 40px)', fontWeight: 900, letterSpacing: '-0.01em' }}>
                  MESSAGE SENT
                </div>
                <p style={{ fontSize: '12px', fontWeight: 300, letterSpacing: '0.1em', color: '#888888', textTransform: 'none' }}>
                ...
                <button
                  ...
                  style={{ borderColor: '#3A3A3A', fontSize: '9px', fontWeight: 700, letterSpacing: '0.18em' }}
                >
                  SEND ANOTHER
                </button>
              </div>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-0">
                ...
                <div className="flex items-center justify-between mt-10 pt-6 border-t" style={{ borderColor: '#1E1E1E' }}>
                  <span style={{ fontSize: '9px', fontWeight: 300, letterSpacing: '0.18em', color: '#888888' }}>
                    * REQUIRED FIELDS
                  </span>
                  <button
                    type="submit"
